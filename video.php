...
<h2 class="page-title">الفيديوهات </h2>
<div class="row">
...
<!-- <input style="width:100%;margin:auto;padding:10px;margin-top:10px;" type="text" id="myInput" onkeyup="myFunction()" placeholder="ادخل اسم الكتاب هنا . . . "> -->
...
foreach($Items As $Item){
  ...
  echo "<p class='data'><span>الفاعلية : </span>$Item[name]</p>";
  echo "<a style='display:none;'>$Item[numb]</a>";
